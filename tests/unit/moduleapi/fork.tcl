...
start_server {tags {"modules external:skip"}} {
    ...
    if {$::tcl_platform(platform) eq "windows"} {
        test {Module fork is unsupported without RedisModule_SetForkChildFn} {
            # CreateProcess cannot return 0 into the module. The stock test
            # module does not register SetForkChildFn, so RM_Fork is ENOSYS.
            assert_error {*Fork failed*} {
