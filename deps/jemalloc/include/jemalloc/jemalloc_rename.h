/*
 * --with-jemalloc-prefix=je_: rename is identity so application code can
 * call je_* directly (zmalloc.c).
 */
...
#  define je_malloc_with_usize je_malloc_with_usize
#  define je_calloc_with_usize je_calloc_with_usize
#  define je_realloc_with_usize je_realloc_with_usize
#  define je_free_with_usize je_free_with_usize
#endif
