...
JEMALLOC_EXPORT int JEMALLOC_NOTHROW je_get_defrag_hint(void *ptr);
#endif
#ifdef JEMALLOC_ALLOC_WITH_USIZE
JEMALLOC_EXPORT JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN
    void JEMALLOC_NOTHROW *je_malloc_with_usize(size_t size, size_t *usize);
JEMALLOC_EXPORT JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN
    void JEMALLOC_NOTHROW *je_calloc_with_usize(size_t num, size_t size,
    size_t *usize);
JEMALLOC_EXPORT JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN
    void JEMALLOC_NOTHROW *je_realloc_with_usize(void *ptr, size_t size,
    size_t *old_usize, size_t *new_usize);
JEMALLOC_EXPORT void JEMALLOC_NOTHROW je_free_with_usize(void *ptr,
    size_t *usize);
#endif
